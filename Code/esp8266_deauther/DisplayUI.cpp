...
void DisplayUI::drawIntro() {    
    ...
    if (scan.isScanning()) {
        if (currentTime - startTime >= screenIntroTime+4500) {
          display.clear();
           display.drawXbm(0, 0, happy_halloween_nugg_width, happy_halloween_nugg_height, happy_halloween_nugg_bits);
           display.display();
//          drawString(4, left(str(D_SCANNING_3), maxLen));
          ...
          display.clear();
           display.drawXbm(0, 0, happy_halloween_nugg_width, happy_halloween_nugg_height, happy_nugg_left_bits);
           display.display();
        }
